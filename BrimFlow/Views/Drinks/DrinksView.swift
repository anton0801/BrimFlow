...
struct SpillwayContainer: UIViewRepresentable {
    let url: URL
    func makeCoordinator() -> SpillwayCoordinator { SpillwayCoordinator() }
    ...
    private func buildWebView(coordinator: SpillwayCoordinator) -> WKWebView {
